...
PositionedObject = namedtuple("PositionedObject", "object position vector overflow overlap")
...
Weights = namedtuple("Weights", fields)
...
class World(MiniGridEnv):
    ...
    def place_object(self, object_spec: Object, position: Position, target=False):
        ...
        positioned_object = PositionedObject(object=object_spec, position=position, vector=object_vector,overflow=False,overlap=False)
